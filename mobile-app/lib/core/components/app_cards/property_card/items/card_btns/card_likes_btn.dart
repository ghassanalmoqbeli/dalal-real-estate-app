...
class CardLikesBtn extends StatelessWidget {
  const CardLikesBtn({
    super.key,
            ...
            return TconBtn(
              ...
              onTap: () {
                ...
                if (user != null) {
                  ...
                  BlocProvider.of<LikeCubit>(context).toggleLike(
                    InteractionReqModel(
...
String getNewLikesCount(String? currentLikesCount, bool isLiked) {
  var intLikesCount = int.tryParse(currentLikesCount ?? '0');
  if (isLiked) {
    intLikesCount = intLikesCount! + 1;
    return intLikesCount.toString();
  } else {
    intLikesCount = intLikesCount! - 1;
    return intLikesCount.toString();
  }
