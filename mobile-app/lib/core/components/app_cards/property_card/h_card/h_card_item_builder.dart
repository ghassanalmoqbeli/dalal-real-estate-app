import 'package:dallal_proj/core/components/app_cards/property_card/h_card/h_card_item.dart';
...
class HCardItemBuilder extends StatelessWidget {
  const HCardItemBuilder({
    super.key,
