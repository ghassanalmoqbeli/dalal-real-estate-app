...
class UnfaveAdvDetUseCase extends UseCase2<RspAuth, InteractionReqModel> {
  final DetailsPageRepo detailsPageRepo;

  UnfaveAdvDetUseCase(this.detailsPageRepo);

  @override
  Future<Either<Failure, RspAuth>> call(InteractionReqModel interAct) async {
    return await detailsPageRepo.unfaveAdv(interAct);
  }
}
