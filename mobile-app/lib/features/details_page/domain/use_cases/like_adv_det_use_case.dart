...
class LikeAdvDetUseCase extends UseCase2<RspAuth, InteractionReqModel> {
  final DetailsPageRepo detailsPageRepo;

  LikeAdvDetUseCase(this.detailsPageRepo);

  @override
  Future<Either<Failure, RspAuth>> call(InteractionReqModel interAct) async {
    return await detailsPageRepo.likeAdv(interAct);
  }
}
