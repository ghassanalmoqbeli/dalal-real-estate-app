...
class FaveAdvDetUseCase extends UseCase2<RspAuth, InteractionReqModel> {
  final DetailsPageRepo detailsPageRepo;

  FaveAdvDetUseCase(this.detailsPageRepo);

  @override
  Future<Either<Failure, RspAuth>> call(InteractionReqModel interAct) async {
    return await detailsPageRepo.faveAdv(interAct);
  }
}
