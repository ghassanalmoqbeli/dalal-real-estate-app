...
class FetchLandsListUseCase extends UseCase<FilterModel, String> {
  final SectionPageRepo sectionPageRepo;

  FetchLandsListUseCase(this.sectionPageRepo);
  @override
  Future<Either<Failure, FilterModel>> call([String? token]) async {
    return await sectionPageRepo.fetchLandsList(token);
  }
}
