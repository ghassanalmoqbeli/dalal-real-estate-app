...
class FetchHousesListUseCase extends UseCase<FilterModel, String> {
  final SectionPageRepo sectionPageRepo;

  FetchHousesListUseCase(this.sectionPageRepo);
  @override
  Future<Either<Failure, FilterModel>> call([String? token]) async {
    return await sectionPageRepo.fetchHousesList(token);
  }
}
