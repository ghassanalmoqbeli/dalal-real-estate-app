...
class FetchShopsListUseCase extends UseCase<FilterModel, String> {
  final SectionPageRepo sectionPageRepo;

  FetchShopsListUseCase(this.sectionPageRepo);
  @override
  Future<Either<Failure, FilterModel>> call([String? token]) async {
    return await sectionPageRepo.fetchShopsList(token);
  }
}
